...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk application in the binding file.
    /// </summary>
    public class ApplicationParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "applicationparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public ApplicationParser(ILogger logger)
            : base(PluginName, Stages.Parse, 10, logger)
        {
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.BizTalkApplicationParser>();
            parser.Parse();
