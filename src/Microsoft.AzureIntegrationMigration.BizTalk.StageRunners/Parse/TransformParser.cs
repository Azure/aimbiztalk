...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk transforms.
    /// </summary>
    public class TransformParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "transformparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransformParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public TransformParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.TransformParser>();
            parser.Parse();
