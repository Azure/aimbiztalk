...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk receive port definitions.
    /// </summary>
    public class ReceivePortParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "receiveportparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivePortParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public ReceivePortParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.ReceivePortParser>();
            parser.Parse();
