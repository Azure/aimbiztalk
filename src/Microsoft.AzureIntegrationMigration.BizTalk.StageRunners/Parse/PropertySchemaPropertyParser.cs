...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk property schema properties.
    /// </summary>
    public class PropertySchemaPropertyParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "propertyschemapropertyparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertySchemaPropertyParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public PropertySchemaPropertyParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.PropertySchemaPropertyParser>();
            parser.Parse();
