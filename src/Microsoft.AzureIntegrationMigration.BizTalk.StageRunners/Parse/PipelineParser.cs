...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk pipeline definition.
    /// </summary>
    public class PipelineParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "pipelineparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PipelineParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public PipelineParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.BizTalkPipelineParser>();
            parser.Parse();
