...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk send port definition.
    /// </summary>
    public class SendPortParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "sendportparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendPortParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public SendPortParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.SendPortParser>();
            parser.Parse();
