...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk document schema resources and properties.
    /// </summary>
    public class DocumentSchemaParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "documentschemaparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentSchemaParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public DocumentSchemaParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.DocumentSchemaParser>();
            parser.Parse();
