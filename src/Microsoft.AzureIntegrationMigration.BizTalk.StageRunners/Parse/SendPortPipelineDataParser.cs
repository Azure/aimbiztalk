...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk send port pipeline data definition.
    /// </summary>
    public class SendPortPipelineDataParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "sendportpipelinedataparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendPortPipelineDataParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public SendPortPipelineDataParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.SendPortPipelineDataParser>();
            parser.Parse();
