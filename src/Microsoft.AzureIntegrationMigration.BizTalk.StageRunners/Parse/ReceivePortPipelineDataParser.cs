...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk receive port pipeline data definition.
    /// </summary>
    public class ReceivePortPipelineDataParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "receiveportpipelinedataparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivePortPipelineDataParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public ReceivePortPipelineDataParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.ReceivePortPipelineDataParser>();
            parser.Parse();
