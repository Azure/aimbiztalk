...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk pipeline components.
    /// </summary>
    public class PipelineComponentParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "pipelinecomponentparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PipelineComponentParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public PipelineComponentParser(ILogger logger)
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.PipelineComponentParser>();
            parser.Parse();
