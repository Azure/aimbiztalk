...
{
    /// <summary>
    /// Defines a parser stage runner that parses BizTalk binding file.
    /// </summary>
    public class BindingFileParser : StageRunnerBase, IStageParser
    {
        /// <summary>
        /// Defines the name of this stage runner.
        /// </summary>
        public const string PluginName = ModelConstants.ApplicationPrefix + "bindingfileparser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BindingFileParser"/> class with a generic logger.
        /// </summary>
        /// <param name="logger">A logger.</param>
        public BindingFileParser(ILogger logger)
            : base(PluginName, Stages.Parse, 20, logger)
        {
        ...
        protected override async Task InvokeRunAsync(IRunState state, CancellationToken token)
        {
            ...
            var parser = Container.GetRequiredService<BizTalk.Parse.BindingFileParser>();
            parser.Parse();
