...
{
    /// <summary>
    /// Tests for the <see cref="OrchestrationPortTypeParser"/> class.
    /// </summary>
    public class OrchestrationPortTypeParserFeature
    {
        ...
        public void ConstructWithNullModel(IBizTalkParser parser, ILogger logger, IApplicationModel model, MigrationContext context, Exception e)
        {
            ...
            "When constructing with null model"
                .x(() => e = Record.Exception(() => new OrchestrationPortTypeParser(model, context, logger)));
        ...
        /// <summary>
        /// Scenario tests the happy path when a port type is parsed.
        /// </summary>
        /// <param name="parser">The parser.</param>
        /// <param name="logger">The logger.</param>
        /// <param name="context">The migration context.</param>
                            ...
                            new Element
                            {
                                ...
                                Element1 = new Element[]
                                {
                                    new Element
                                    {
                                        ...
                                        {
                                            new ElementProperty { Name = "Name", Value = portTypeName }
                                        }
                                    }
                                }
                            }
